    ...
    >
      <div className="relative z-[1] mx-auto max-w-[820px] px-7 pb-20 pt-6">
        ...
        <div className="space-y-2 pb-8">
          <h1
            className="text-[32px] font-medium tracking-[-0.02em] text-paper"
        ...
        <section id="terms" className="scroll-mt-24 space-y-4 border-t border-paper/10 py-10">
          <h2 className="text-xl font-semibold text-paper">Terms of Service</h2>

          <div className="space-y-4 text-sm leading-6 text-paper/70">
            <p>
              <strong className="text-paper/90">1. What this is.</strong> ScoutLane is a
            ...
            <p>
              <strong className="text-paper/90">2. Demo accounts.</strong> One-click &ldquo;Enter
            ...
            <p>
              <strong className="text-paper/90">3. Public job applications.</strong> The public
              job board (<code className="rounded bg-paper/10 px-1.5 py-0.5">/jobs</code> and{" "}
              <code className="rounded bg-paper/10 px-1.5 py-0.5">/careers/*</code>) accepts real
            ...
            <p>
              <strong className="text-paper/90">4. No warranty.</strong> ScoutLane is provided
            ...
            <p>
              <strong className="text-paper/90">5. Acceptable use.</strong> Don&rsquo;t use the
        ...
        <section id="privacy" className="scroll-mt-24 space-y-4 border-t border-paper/10 py-10">
          ...
          <div className="space-y-4 text-sm leading-6 text-paper/70">
            ...
            <p>
              <strong className="text-paper/90">Storage &amp; retention.</strong> Uploaded resume
            ...
            <p>
              <strong className="text-paper/90">Third parties.</strong> Authentication: Clerk.
            ...
            <p>
              <strong className="text-paper/90">Your choices.</strong> Don&rsquo;t submit
