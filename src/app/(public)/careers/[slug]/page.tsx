    ...
    <div className="flex min-h-screen items-center justify-center" style={{ background: "#0c1529", fontFamily: "var(--font-body)" }}>
      <div className="text-center">
        <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-[18px] text-white shadow-[0_12px_30px_rgba(27,44,193,0.45),inset_0_1px_0_rgba(255,255,255,0.16)]"
          style={{ background: "linear-gradient(135deg, #1B2CC1, #3D518C)", fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "28px", letterSpacing: "-0.04em" }}>
          SL
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl"
                  style={{ background: "linear-gradient(135deg, #1B2CC1, #3D518C)", boxShadow: "0 8px 20px rgba(27,44,193,0.35), inset 0 1px 0 rgba(255,255,255,0.12)" }}>
          ...
          <aside className="lg:pt-0">
            <div className="lg:sticky lg:top-6">
              {status === "active" ? (
                ...
                <div className="rounded-2xl border border-white/[0.08] bg-[#14213d] p-6">
