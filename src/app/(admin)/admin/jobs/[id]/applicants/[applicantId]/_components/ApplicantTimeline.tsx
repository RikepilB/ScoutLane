    ...
    <div className="rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
      ...
      <div className="mt-3 space-y-3">
        <div className="flex items-start gap-3">
          <div className="flex h-6 w-6 items-center justify-center rounded-full bg-peri">
            <div className="h-2 w-2 rounded-full bg-peri" />
          </div>
          <div>
            <p className="text-sm text-ink-900">Application submitted</p>
        ...
        {transitions.map((t) => (
          <div key={t.id} className="flex items-start gap-3">
            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-sky">
