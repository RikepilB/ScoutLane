  ...
  return (
    <div className="rounded-2xl border border-border/70 bg-card p-6 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div>
          <h3 className="text-sm font-semibold text-ink-900">Structured applicant data</h3>
      ...
      <textarea
        ...
        spellCheck={false}
        rows={14}
        className="mt-3 w-full rounded-xl border border-border/60 bg-ink-950/90 p-3 font-mono text-xs leading-relaxed text-paper outline-none focus:border-sky"
      />
    </div>
  );
}
