...
export function CareersHero({ count, session }: CareersHeroProps) {
  return (
    <header className="animate-fade-up relative overflow-hidden rounded-[24px] border border-brand-royal-dark px-12 pb-11 pt-14"
      style={{
      ...
      <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-[600px]">
          ...
          <div className="mb-6 inline-flex items-center gap-2.5 rounded-full border border-[rgba(171,210,250,0.25)] bg-[rgba(171,210,250,0.08)] py-1.5 pl-2 pr-3 text-[10px] font-medium uppercase tracking-[0.12em] text-sky"
            style={{ fontFamily: "var(--font-mono)" }}>
            <span className="h-1.5 w-1.5 animate-pulse-glow rounded-full bg-sky" />
            AI-powered recruitment
          </div>

          {/* Title */}
          <h1 className="mb-5 text-[clamp(36px,5vw,46px)] font-medium leading-[1] tracking-[-0.03em] text-paper"
            style={{ fontFamily: "var(--font-display)" }}>
            Current job openings<br />at ScoutLane
          </h1>

          {/* Subtitle */}
          <p className="mb-8 max-w-[520px] text-[15px] leading-[22px] text-paper/70">
          ...
          {/* Meta line */}
          <div className="flex items-center gap-2.5 text-[12px] uppercase tracking-[0.1em] text-paper/55"
            style={{ fontFamily: "var(--font-mono)" }}>
