    ...
    <nav className={cn("flex items-center justify-between py-2", className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <a
          ...
          className="ml-1 inline-flex h-11 w-11 items-center justify-center rounded-full text-paper/70 transition-colors hover:bg-paper/[0.06] hover:text-paper"
        >
        ...
        <Link
          ...
          className="ml-1 inline-flex items-center rounded-control bg-brand-royal px-3 py-2 text-[13px] font-medium text-paper transition-colors hover:bg-brand-royal-hover sm:ml-2 sm:px-4 sm:text-[14px]"
        >
