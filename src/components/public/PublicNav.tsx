  ...
  return (
    <nav className={cn("flex items-center justify-between py-2", className)}>
      <Link href="/" className="flex items-center gap-3">
        ...
        <span className="text-[17px] font-semibold text-paper" style={{ fontFamily: "var(--font-display)" }}>
          ScoutLane
        </span>
      </Link>
      ...
      <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Link
              ...
              className={cn(
                ...
                active
                  ...
                  : "text-paper/70 hover:bg-white/[0.06] hover:text-white",
              )}
            >
              {link.label}
            </Link>
        ...
        <a
          ...
          className="ml-1 inline-flex h-9 w-9 items-center justify-center rounded-full text-paper/70 transition-colors hover:bg-white/[0.06] hover:text-white"
        >
