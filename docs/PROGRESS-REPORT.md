...
> **⚠️ ARCHIVED** — Snapshot of spec gaps as of 2026-05-12. **Superseded by `docs/BACKLOG.md`**, which decomposes remaining work into trackable subtasks. Kept here as a historical reference of the initial gap analysis.
